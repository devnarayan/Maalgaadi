        ...
        <?php include '../includes/header.php'; ?>
            ...
            <div class="crumbs">
                <ul id="breadcrumbs" class="breadcrumb">
                    ...
                    <li class="active"><a title="">Discount Coupons List</a></li>
                </ul>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#example thead th:first-child').each(function () {
                ...
                $(this).html('<input type="text" style="width:60px;" placeholder="Coupon code" />');
            });
           
            var table = $('#example').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "discount_coupon_data.php",
            });
        ...
        function delete_menu(value)
        {
            ...
            {
                  document.location.href = 'discount_coupon_update.php?mode=delete_coupon&id='+value;  
            } 
        }
