            ...
            <table border="0" cellpadding="5" cellspacing="0" width="100%">
                ...
                <td valign="top" width="20%" class="mtb"><label>Customer Organization</label><span class="star"></span></td>        
                    <td class="mtb">
                        <div class="new_input_field">
                            <div class="new_input_field">
                                <select required name="customer_organization" id="customer_organization" onchange="if (this.value == '') {
                                                            $('#other').show();
                                                        } else {
                                                            $('#other').hide();
                                                            $('#other').val('');
                ...
                <td>&nbsp;</td>
                                        <td colspan="2">
                                            ...
                                            <div class="button greenB">  <input type="button" class="my_btn" value="Search" title="submit" onClick="formSubmitCusBal('reportSearch1','searchResult','customer_balance_report_data.php')" /></div>
                                            <div class="clr">&nbsp;</div>
