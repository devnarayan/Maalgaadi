...
?>
        <div class="content_middle mt15">   
            <form method="get"  id="reportSearch1" action="customer_discount_report_data.php">
            <table border="0" cellpadding="5" cellspacing="0" width="100%">
                <tr>
                    <td colspan="4" class="style_1">Customer Discount Report</td>
                  ...
                  <tr>
                    ...
                    <td colspan="3">
                         <div class="new_booking_field ">
                             <input required type="text" title="Enter the first name with atleast 3 character" name="firstname" id="firstname" value=""  minlength="3"  placeholder="First Name"  autocomplete="off" />
                ...
                <tr>
                    ...
                    <td class="mtb">
                        <div class="new_input_field">
                            <input required type="text" title="Satrt Date From the booking should be search" id="startDate" name="startDate" readonly />
                        </div>
                    </td>
                     <td valign="top" width="20%" class="mtb"><label>End Date</label><span class="star">*</span></td>        
                    <td class="mtb">
                        <div class="new_input_field">
                            <input required type="text" title="End Date To the booking should be search" id="endDate" name="endDate" readonly />
                        </div>
                    </td>
                ...
                <td>&nbsp;</td>
                                        <td colspan="2">
                                            ...
                                            <div class="button greenB">  <input type="button" class="my_btn" value="Search" title="submit" onclick="formSubmitCus('reportSearch1','searchResult','customer_discount_report_data.php')" /></div>
                                            <div class="clr">&nbsp;</div>
...
<script>
    ...
    function onshowHide(L)
    {
        $('#showhie1').attr("src","details_open.png");
        $('.allhisde').hide();
        $('#hidShow_'+L).show();
        $('#showhie_'+L).attr("src","details_close.png");
