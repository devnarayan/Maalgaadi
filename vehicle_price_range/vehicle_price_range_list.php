    ...
    <script>
        ...
        $(document).ready(function () {
            $('#example thead th:first-child').each(function () {
                ...
                $(this).html('<input type="text" style="width:100px;" placeholder="Vehicle Category" />');
            });
           
            var table = $('#example').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "vehicle_price_range_data.php",
            });
        ...
        function delete_menu(value)
        {
            ...
            {
                  document.location.href = 'vehicle_price_range_update.php?mode=delete_range&id='+value;  
            } 
        }
