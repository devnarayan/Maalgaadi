                    ...
                    <div class="customerDetail" id="customerDetail">
                        <div class="first_fieldset fl ml1p ">
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Organization Name" name="organization" id="organization" class="" value="" placeholder="Organization"  />
                                </div>
                                <div class="new_booking_field mt10">
                                    <textarea title="Address" name="address" id="address" class="" value="" placeholder="Addresss"  ></textarea>
                                </div>
                                <div class="new_booking_field mt10">
                                    <select  title="Select Customer Category" name="customer_category" id="customer_category" class="required " >
