                                                ...
                                                <div class="span12"> 
                                                    <form id="assign_employee" method="post">
                                                        <table border="0" cellspacing="0" cellpadding="5" width="100%">
                                                            <tr>
                                                                <td valign="top" width="20%" class="mtb"><label>Reason</label><span class="star">*</span></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    ...
                                                                    <input type="hidden" name="mode" value="cancelbooking" />
                                                                    <input type="hidden" name="booking_id" value="<?php echo $id; ?>" />
                                                                    <div class="button greenB">  <input type="button" class="my_btn" value="submit" onclick="formSubmit('assign_employee', 'assign_employee_result', 'booking_update.php')" title="submit"></div>
