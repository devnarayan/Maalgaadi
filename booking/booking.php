                ...
                <form name="booking_form" class="form" id="booking_form" action="" method="post" enctype="multipart/form-data" onSubmit="">
                    <div class="customerDetail" id="customerDetail">
                            ...
                            <fieldset class="booking-form-fieldset">
                                <legend>CUSTOMER INFORMATION</legend>
                                 ...
                                 <div class="new_booking_field ">
                                    <input type="text" title="Organization Name" name="organization" id="organization" class="" value="" placeholder="Organization" autocomplete="off" />
                                     <input name="organization_id" id="organization_id" type="hidden" >
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Organization Email" name="organization_email" id="organization_email" class="" value="" placeholder="Organization Email" autocomplete="off" />
                                     
                                </div>
                                <div class="new_booking_field mt10">
                                    <textarea title="Organization Address" name="organization_address" id="organization_address" class="" value="" placeholder="Organization Addresss" autocomplete="off" ></textarea>
                                </div>
                                <div class="new_booking_field mt10">
                                ...
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the email address" class="email" name="email" id="email" value=""  maxlength="50" placeholder="Email" autocomplete="off"/>
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the mobile number minimum with 7 numbers" name="phone" id="phone" class="required digits" value="" minlength="7" maxlength="20" placeholder="Mobile" autocomplete="off" />
                                </div>
                               
                                <div class="new_booking_field mt10">
                                    <textarea title="Address" name="address" id="address" class="" value="" placeholder="Addresss" autocomplete="off" ></textarea>
                                </div>
                                <div class="new_booking_field mt10">
                                ...
                                <div class="new_booking_field mt10">
                                    <input type="number" title="No. Of Drop Pointse" name="no_of_drop_points" id="organization" class="" value="" placeholder="No. Of Drop Points" autocomplete="off" />
                                </div>
                        ...
                        <div class="first_fieldset fl ml4p" >
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field mt10">
                                    <select name="vehicle" id="vehicle" class="required" title="Select the Taxi Model" OnChange="vehicle_info(this.value);" >
                        ...
                        <div class="first_fieldset fr mr1p">
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Pickup Date" class="" name="pickup_date" id="pickup_date" value="<?php echo date("d/m/Y H:i", strtotime(date("Y-m-d H:i"))); ?>"  autocomplete="off" placeholder="Today" readonly />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter in round value(Kg)" class="onlynumbers" name="luggage" id="luggage" value=""  autocomplete="off" placeholder="Volume" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <textarea title="Write a note to driver" name="notes" id="notes" value=""  autocomplete="off"  placeholder="Write a note to driver" ></textarea>
                                </div>
                    ...
                    <div class="pickupDetail" id="pickupDetail">
                        <div class="first_fieldset fl ml1p">
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field">
                                    <input type="text" title="Enter the Pickup Person Name" class="required " name="pick_up_name" id="pick_up_name" value=""  autocomplete="off"  placeholder="Enter the Pickup name" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="number" minlength="10" title="Enter the Pickup Person Mobile No" class="required " name="pick_up_no" id="pick_up_no" value=""  autocomplete="off"  placeholder="Enter the Pickup Number" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Pickup organization"  name="pick_up_organization" id="pick_up_organization" value=""  autocomplete="off"  placeholder="Enter the Pickup organization" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Pickup Address" name="current_location" id="current_location" value=""  autocomplete="off"  placeholder="Enter the Pickup Address" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Pickup Landmark" class="required " name="pick_up_landmark" id="pick_up_landmark" value=""  autocomplete="off"  placeholder="Enter the Pickup Landmark" onChange="GeocodeFromAddress()"/>
                    ...
                    <div class="myownh1 space1" id="payment">
                        <div class="first_fieldset fl">
                            ...
                            <input type="hidden" name="mode" value="bookingnew">
                            <input type="button" value="Book Now" id="booking_button" class="btn btn-success book-now" onClick="$('#booking_button').hide();formSubmit('booking_form', 'form_result', 'booking_update.php')">
