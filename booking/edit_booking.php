...
<html>
    ...
    <body data-base="<?php echo BASE_URL; ?>">
                    ...
                    <div class="customerDetail" id="customerDetail">
                        <div class="first_fieldset fl ml1p ">
                            <fieldset class="booking-form-fieldset">
                                ...
                                <?php
                                    ...
                                    if($ch['edit_status']=='start_trip')
                                    {
                                        $flag=1;
                                    }else if($ch['edit_status']=='reach_to_customer')
                                    {
                                        $flag=2;
                                    }else if($ch['edit_status']=='stop_trip')
                                    {
                                        $flag=3;
                                    }
                                ...
                                ?>
                                 ...
                                 <div class="new_booking_field ">
                                    <input type="text" title="Organization Name" <?php if($flag>0){ echo"readonly";} ?> name="organization" id="organization" class="" value="" placeholder="Organization" autocomplete="off" />
                                     <input name="organization_id" id="organization_id" type="hidden" >
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Organization Email" <?php if($flag>0){ echo"readonly";} ?> name="organization_email" id="organization_email" class="" value="" placeholder="Organization Email" autocomplete="off" />
                                     
                                </div>
                                <div class="new_booking_field mt10">
                                    <textarea title="Organization Address" <?php if($flag>0){ echo"readonly";} ?> name="organization_address" id="organization_address" class="" value="" placeholder="Organization Addresss" autocomplete="off" ></textarea>
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the first name with atleast 3 character"  <?php if($flag>0){ echo"readonly";} ?> class="required" name="firstname" id="firstname" value=""  minlength="3"  placeholder="First Name"  autocomplete="off" />
                                    <input name="customer_id" id="customer_id" type="hidden" >
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the email address" <?php if($flag>0){ echo"readonly";} ?> class="email" name="email" id="email" value=""  maxlength="50" placeholder="Email" autocomplete="off"/>
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the mobile number minimum with 7 numbers" <?php if($flag>0){ echo"readonly";} ?> name="phone" id="phone" class="required digits" value="" minlength="7" maxlength="20" placeholder="Mobile" autocomplete="off" />
                                </div>
                               
                                <div class="new_booking_field mt10">
                                    <textarea title="Address" name="address" id="address" class="" value="" <?php if($flag>0){ echo"readonly";} ?> placeholder="Addresss" autocomplete="off" ></textarea>
                                </div>
                                <div class="new_booking_field mt10">
                                    <select type="text" title="Select Customer Category" name="customer_category" <?php if($flag>0){ echo"readonly";} ?> id="customer_category" class="required " autocomplete="off">
                                        <option class="Regular" value="">Select Customer Type</option>
                                        <option class="Regular">Regular</option>
                                        <option class="Corporate">Corporate</option>
                                    </select>
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="number" title="No. Of Drop Pointse" <?php if($flag>0){ echo"readonly";} ?> name="no_of_drop_points" id="organization" class="" value="" placeholder="No. Of Drop Points" autocomplete="off" />
                                </div>
                        ...
                        <div class="first_fieldset fl ml4p" >
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field mt10">
                                    <select name="vehicle" id="vehicle" <?php if($flag>0){ echo"readonly";} ?> class="required" title="Select the Taxi Model" OnChange="vehicle_info(this.value);" >
                                ...
                                <div class="new_booking_field mt10 clear">
                                    <div class="fl">Un Loading Charge </div>
                                    <div class="fr"><i class="fa fa-rupee"></i>
                                        <input type="text" readonly id="unloading_charge" name="unloading_charge" class="onlyData" value="0.00"/>
                                    </div>
                                </div>
                        ...
                        <div class="first_fieldset fr mr1p">
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Pickup Date" class="" <?php if($flag>0){ echo"readonly";} ?> name="pickup_date" id="pickup_date" value="<?php echo date("d/m/Y H:i", strtotime(date("Y-m-d H:i"))); ?>"  autocomplete="off" placeholder="Today" readonly />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter in round value(Kg)" <?php if($flag>0){ echo"readonly";} ?> class="onlynumbers" name="luggage" id="luggage" value=""  autocomplete="off" placeholder="Volume" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <textarea title="Write a note to driver" <?php if($flag>0){ echo"readonly";} ?> name="notes" id="notes" value=""  autocomplete="off"  placeholder="Write a note to driver" ></textarea>
                                </div>
                            ...
                            <fieldset class="booking-form-fieldset">
                                <legend>Discount Info</legend>
                                 <div class="new_booking_field mt10 clear">
                                        ...
                                        <div class="fr"> <span id="discount_info" class="onlyData" >0.00</span> </div>
                                </div>

                                <!-- <div class="new_booking_field mt20 mb50"></div> -->
                            </fieldset>
                            <div style="width:100%" align="right">
                                <input type="button" <?php if($flag>0){ echo"readonly";} ?> class="btn btn-warning edit_btn" onClick="paneonevalidate()" style="" value="Next"/>
                            </div>
                        </div>
                        <div class="first_fieldset fr mr1p" style="margin-right: 4%;">
                              <fieldset class="booking-form-fieldset">
                                    <legend>Payment Info</legend>
                                    <div class="new_booking_field mt10 clear">
                                        <div class="fl"> Balance </div>
                                        <div class="fr"> <span id="payment_info" class="onlyData" >0.00</span> </div>
                                    </div>
                    ...
                    <div class="pickupDetail" id="pickupDetail">
                        <div class="first_fieldset fl ml1p">
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field">
                                    <input type="text" title="Enter the Pickup Person Name" <?php if($flag>1){ echo"readonly";} ?> class="required " name="pick_up_name" id="pick_up_name" value=""  autocomplete="off"  placeholder="Enter the Pickup name" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="number" minlength="10" <?php if($flag>1){ echo"readonly";} ?> title="Enter the Pickup Person Mobile No" class="required " name="pick_up_no" id="pick_up_no" value=""  autocomplete="off"  placeholder="Enter the Pickup Number" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Pickup organization" <?php if($flag>1){ echo"readonly";} ?> name="pick_up_organization" id="pick_up_organization" value=""  autocomplete="off"  placeholder="Enter the Pickup organization" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Pickup Address" <?php if($flag>1){ echo"readonly";} ?> name="current_location" id="current_location" value=""  autocomplete="off"  placeholder="Enter the Pickup Address" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Pickup Landmark" class="required " <?php if($flag>1){ echo"readonly";} ?> name="pick_up_landmark" id="pick_up_landmark" value=""  autocomplete="off"  placeholder="Enter the Pickup Landmark" onChange="GeocodeFromAddress()"/>
                            ...
                            <div style="width:100%" align="left">
                                <input type="button" class="btn btn-warning edit_btn" <?php if($flag>1){ echo"readonly";} ?> onClick="panethreevalidate()" style="" value="View Driver">
                                <input type="button" class="btn btn-warning edit_btn" <?php if($flag>1){ echo"readonly";} ?> onClick="panetwovalidate()" style="" value="Next">
                            </div>
                        </div>
                         <?php if($flag>1)
                                {
                    ...
                    <div class="dropDetail" id="dropDetail">
                        <div class="first_fieldset fl ml1p">
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field">
                                    <input type="text" title="Enter the Drop Person Name" <?php if($flag>2){ echo"readonly";} ?>  name="drop_name" id="drop_name" value=""  autocomplete="off"  placeholder="Enter the Drop name" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="number" minlength="10" title="Enter the Drop Person Mobile No" <?php if($flag>2){ echo"readonly";} ?>  name="drop_number" id="drop_number" value=""  autocomplete="off"  placeholder="Enter the Drop Number" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Drop organization" <?php if($flag>2){ echo"readonly";} ?>  name="drop_organization" id="drop_organization" value=""  autocomplete="off"  placeholder="Enter the Drop organization" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Drop Address" class="required " <?php if($flag>2){ echo"readonly";} ?> name="drop_location" id="drop_location" value=""  autocomplete="off" placeholder="Enter the Drop Location" />
                                </div>
                                <div class="new_booking_field mt10">
                                    <input type="text" title="Enter the Drop Location" class="required " <?php if($flag>2){ echo"readonly";} ?> name="drop_landmark" id="drop_landmark" value=""  autocomplete="off" placeholder="Enter the Drop Landmark" onChange="GeocodeFromAddress()"/>
                            ...
                            <div style="width:100%" align="left">
                                <input type="button" class="btn btn-warning edit_btn" <?php if($flag>2){ echo"readonly";} ?> onClick="panethreevalidate()" style="" value="Next">
                            </div>
                        </div>
                        ...
                        <div class="first_fieldset fl">
                            ...
                            <fieldset class="booking-form-fieldset">
                                ...
                                <div class="new_booking_field mt10 clear">
                                    ...
                                    <div class="fr">
                                        <input type="checkbox" <?php if($flag>2){ echo"readonly";} ?> onChange="calculate_totalfare();" id="loading" name="loading" value="true"/>
                                    </div>
                                </div>
                                <div class="new_booking_field mt10 clear">
                                    <div class="fl"> Un Loading </div>
                                    <div class="fr">
                                        <input type="checkbox" <?php if($flag>2){ echo"readonly";} ?> id="unloading" onChange="calculate_totalfare();" name="unloading" value="true"/>
                                    </div>
                                </div>
                                <div class="new_booking_field mt10 clear">
                               ...
                               <div class="new_booking_field mt10 clear">
                                    <div class="fl"> Expected Total Fare </div>
                                    <div class="fr"><i class="fa fa-rupee"></i>
                                        <input type="number" <?php if($flag>2){ echo"readonly";} ?>  name="total_exp_fare" id="total_exp_fare" class="form-data" value="" style="width: 80px;"> <!-- -->
                                    </div>
                               </div>
                            ...
                            <input type="button" <?php if($flag>2){ echo"readonly";} ?> value="Book Now" id="booking_button" class="btn btn-success book-now" onClick="$('#booking_button').hide();formSubmit('booking_form', 'form_result', 'booking_update.php')">
        ...
        <script>
            ...
            function paymentinfo(value)
            {
                $.ajax({
                    url:'booking_update.php?mode=payment_info&value='+value,
            ...
            function discount_info(value)
            {
                $.ajax({
                    url:'booking_update.php?mode=discount_info&value='+value,
                    success: function(data){
                        //alert(data)
...
//                                        source: 'booking_update.php?mode=autocompleteFirstname',
                                       ...
                                       // alert(organization_id);
                                        ...
                                        select: function (event, ui) {
                                            ...
                                            $('#organization').val(ui.item.organization_name);
                                            $('#organization_id').val(ui.item.organization_id);
                                            $('#organization_email').val(ui.item.organization_email);
                                            $('#organization_address').val(ui.item.organization_address);
                                            ...
                                            paymentinfo(ui.item.id);
                                            discount_info(ui.item.id);
                                            return false;
                                        },
                                        minLength: 1
                                    });
...
//                                        source: 'booking_update.php?mode=autocompleteFirstname',
                                        source: 'booking_update.php?mode=autocompleteorganization',
                                        select: function (event, ui) {
                                            console.log(ui.item.id);
                                            $('#organization').val(ui.item.customer_name);
                                            $('#organization_id').val(ui.item.id);
                                            $('#organization_email').val(ui.item.customer_email);
                                            $('#organization_address').val(ui.item.address);
                                            $('#customer_id').val(ui.item.cus_id);
                                            $('#firstname').val(ui.item.cus_customer_name);
                                            $('#email').val(ui.item.cus_customer_email);
                                            $('#phone').val(ui.item.cus_customer_number);
                                            $('#address').val(ui.item.cus_customer_address);
                                            $('#customer_category').val(ui.item.customer_category);
                                            fetchpickupDrop(ui.item.cus_id);
                                            paymentinfo(ui.item.cus_id);
                                            discount_info(ui.item.cus_id);
                                            return false;
                                        },
                                        minLength: 1
                                    });
...
//                                        source: 'booking_update.php?mode=autocompleteEmail',
                                ...
                                function vehicle_info(vehicle_id) {
                                    if (vehicle_id != "") {
                                        $.post("booking_update.php", {mode: "vehicle_detail", model_id: vehicle_id}, function (data) {
                                            ...
                                            $("#unloading_charge").val(parseFloat(item.unloading_charge).toFixed(2));
                                ...
                                function fillinlatlng(gat) {
                                    //alert(gat + "123");
                                    var ads = gat.split("|");

                                    $("#fav_pickup_lat").val(ads[0]);
                                    $("#fav_pickup_lng").val(ads[1]);
                                ...
                                function GeocodeFromAddress() {
                                    ...
                                    function (results, status) {
                                        if (results[0]) {
                                            ...
                                            getNearestDriver(result.geometry.location.lat(), result.geometry.location.lng());
                                ...
                                function calculate_totalfare() {
                                    ...
                                    var unloading_charge = $("#unloading_charge").val();
...
//alert();
                                    ...
                                    if (unloading) {
                                        total_fare = parseFloat(total_fare) + parseFloat(unloading_charge);
                                    }
            ...
            $.post('booking_update.php', {mode: "editbooking", id: <?php echo $_GET['booking'];?>}).done(function (data) {
                ...
                if (data != 'false') {
                    ...
                    $('#customer_category').val(json.customer_category);
