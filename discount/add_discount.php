...
<div class="crumbs">
              <ul id="breadcrumbs" class="breadcrumb">
                 ...
                 <li>
                    <a href="<?php echo BASE_URL; ?>discount/view_discount.php" title="<?php echo BASE_URL; ?>">View Customer Discount</a></li>
                <li class="active"><a title="">Add Customer Discount </a></li>
              </ul>
            </div>
        ...
        <div class="widget mt15">
            ...
            <div class="content_middle">
                ...
                $id = $_REQUEST['id'];
                $result6 = $objConnect->selectWhere("discount", "id=$id ");
                ...
                ?>
                            <form name="adddiscount_form" id="adddiscount_form" class="form" action="" method="post" enctype="multipart/form-data">
                                <table border="0" cellpadding="5" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td valign="top" width="20%"><label>Discount Date</label><span class="star">*</span></td>        
                                        <td>
                                            <div class="new_input_field ">

                                                <input type="text" title="Enter The Discount Date" class="required " value="<?php echo $discount_date; ?>" name="discount_date" id="discount_date"   />

                                            </div>
                                        </td>   	
                                    </tr> 
                                    <tr>
                                        <td valign="top" width="20%"><label>Discount Amount</label><span class="star">*</span></td>        
                                        <td>
                                            <div class="new_input_field ">

                                                <input type="text" title="Enter The Discount Amount" class="required " value="<?php echo $discount_amount; ?>" name="discount_amount" id="discount_amount"   />
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="button greenB">  <input type="button" value="submit" onClick="formSubmit('adddiscount_form', 'form_result', 'discount_update.php')" title="submit" /></div>
                                            <div class="clr">&nbsp;</div>
