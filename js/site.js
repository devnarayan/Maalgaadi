...
(function(b) {
    ...
    b.widget("ui.button", {
        ...
        _setOption: function(a, c) {
            ...
            if (a === "disabled") c ? this.element.attr("disabled", true) : this.element.removeAttr("disabled");
    ...
    d.extend(M.prototype, {
        ...
        _generateMonthYearHeader: function(a, b, c, e, f, h, i, g) {
            ...
            if (h || !j) o += '<span class="ui-datepicker-month">' + i[b] + "</span>";
                ...
                for (var n = 0; n < 12; n++)
                    if ((!i || n >= e.getMonth()) && (!m || n <= f.getMonth())) o += '<option value="' +
...
$(document).ready(function() {
    ...
    $("#cse-search-box button:submit").button({
        icons: {
...
function getKmlErrorMsg(status) {
    switch (status) {
        case google.maps.KmlLayerStatus.DOCUMENT_TOO_LARGE:
            return "Document is too large to display";
